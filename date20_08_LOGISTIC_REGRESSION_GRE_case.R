...
inputData
summary(inputData)
sapply(inputData, sd) #sapply = simple apply is calculating sd of each and every column in the dataset
str(inputData)
...
xtabs(~admit + rank, data = data) #xtabs similar to pivot table in excel
